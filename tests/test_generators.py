...
from src import filter_by_currency, transaction_descriptions, card_number_generator
...
def sample_transactions() -> List[Dict[str, Any]]:
    ...
    return [
        {"id": 1, "state": "EXECUTED", "date": "2024-01-01", "description": "USD Transaction 1",
         "operationAmount": {"amount": 100, "currency": {"code": "USD"}}},
        {"id": 2, "state": "EXECUTED", "date": "2024-01-02", "description": "USD Transaction 2",
         "operationAmount": {"amount": 200, "currency": {"code": "USD"}}},
        {"id": 3, "state": "EXECUTED", "date": "2024-01-03", "description": "EUR Transaction 1",
         "operationAmount": {"amount": 300, "currency": {"code": "EUR"}}},
        {"id": 4, "state": "EXECUTED", "date": "2024-01-04", "description": "Other Transaction",
...
def test_filter_by_currency(sample_transactions: List[Dict[str, Any]], currency_code: str, expected_count: int,
